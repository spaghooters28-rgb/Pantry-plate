...
// Brand names checked first so e.g. "Dr Pepper" → Beverages, not "pepper" → Produce
...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  "Beverages": [
    ...
    "cold brew", "protein shake", "smoothie mix", "sports drink", "electrolyte",
  ],
  "Frozen": [
...
function detectCategory(name: string): string | null {
  ...
  // Check brand names first (higher priority, avoids false positives)
